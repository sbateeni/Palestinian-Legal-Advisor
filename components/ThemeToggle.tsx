...
const ThemeToggle: React.FC = () => {
    ...
    return (
        <button
            ...
            className="p-2 rounded-xl transition-all duration-300 bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-amber-400 hover:ring-2 hover:ring-blue-400 focus:outline-none"
