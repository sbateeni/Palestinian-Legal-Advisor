...
const Header: React.FC = () => {
    ...
    const navLinkClass = (href: string) => {
        ...
        return `inline-flex shrink-0 p-2 rounded-xl transition-all duration-200 flex-col sm:flex-row items-center justify-center gap-1 ${
            isActive
    ...
    return (
        <header className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-gray-200 dark:border-slate-800 safe-area-padding transition-colors duration-300">
            <nav className="container mx-auto px-2 sm:px-4">
                <div className="flex justify-between items-center h-20 sm:h-16">
                    <div className="flex items-center flex-shrink-0">
                        <Link href="/" className="flex items-center space-x-2 space-x-reverse group">
                            ...
                            <span className="font-black text-gray-900 dark:text-white text-base sm:text-lg hidden xs:block">
                                المستشار
                            </span>
                        </Link>
                    </div>

                    <div className="flex-grow flex min-w-0 items-center justify-center overflow-x-auto scrollbar-hide px-2">
                        <div className="flex items-center gap-1 sm:gap-2">
                            <Link href="/cases" className={navLinkClass('/cases')} title="سجل القضايا">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <Link href="/ocr" className={navLinkClass('/ocr')} title="تحليل المستندات">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 shrink-0"
                                    fill="none"
                            ...
                            <Link href="/inheritance" className={navLinkClass('/inheritance')} title="حاسبة المواريث">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 shrink-0"
                                    fill="none"
                            ...
                            <Link href="/research" className={navLinkClass('/research')} title="البحث القانوني">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 shrink-0"
                                    fill="none"
                            ...
                            <Link
                                ...
                                title="تبليغات النشر — دائرة التبليغات، مجلس القضاء الأعلى (courts.gov.ps/notifications)"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 shrink-0"
                                ...
                                <span className="text-[10px] sm:text-xs font-bold hidden md:block">تبليغات</span>
                            </Link>

                            <Link href="/tools" className={navLinkClass('/tools')} title="حاسبة الرسوم والمهل">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 shrink-0"
                                    fill="none"
                    ...
                    <div className="flex items-center gap-1 sm:gap-3 flex-shrink-0">
                        <div className="hidden lg:block">
                            <TokenTracker variant="inline" />
                        </div>

                        <div className="flex items-center gap-1 shrink-0">
                            <ThemeToggle />

                            <Link href="/settings" className={navLinkClass('/settings')} title="الإعدادات">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-5 w-5 shrink-0"
                                    fill="none"
                ...
                <div className="hidden sm:flex lg:hidden border-t border-gray-100 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-950/50 px-3 sm:px-4 py-1.5 justify-end">
                    <TokenTracker variant="bar" />
                </div>
            </nav>
